...
to load-input
  ...
  set landCov94 gis:load-dataset "Input/landcover_94.asc"
  gis:apply-raster landCov94 field-land-use
  
  ask patches 
  [
    set field-land-use field-land-use
  ]
...
159
test
ask patches\n[ ifelse (field-land-use >= 0) or (field-land-use <= 0)\n[set pcolor blue]\n[set pcolor red]\n]
NIL
1
T
OBSERVER
